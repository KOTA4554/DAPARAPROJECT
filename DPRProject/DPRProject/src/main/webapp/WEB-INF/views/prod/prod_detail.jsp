											...
											<div class="tableArea" style="text-align: center;">
												...
												<table cellspacing="100" id="listArea" align="center" style="width: max-content;">
													...
													<tbody align="center">
														...
														<tr>
															<td style="height: 50px; border-top:solid ; border-color: rgb(237, 237, 240);">장민수</td> 
															<td style="border-top:solid ; border-color: rgb(237, 237, 240); padding-left : 50px; padding-right : 50px; text-align : left">어디까지길어져어디까지길어디까지지길어져어디까지길어져어디까지길어져</td> 
												...
												<tr>
												<td width="80px" style="text-align:center; font-weight:700;">작성자</td>
												<td width="980px" style="text-align:center"  > <input type="text" style="width:950px; height:50px; border-width:1px; border-radius:5px;  border-color:#b8b8b8;"/> </td>
												<td width="80px" style="text-align:center; font-size : 15px;"> <button style="height:50px; border-width:1px; border-radius:5px; border-color:#b8b8b8; ">문의하기</button> </td>

...
<div class="mainSectionForm">
	...
	<table id="prodListTable" border="0">
	    ...
	    <c:forEach items="${reviewList}" var="reviewList" varStatus="status">
		    <tr class="prodListRows" id="${reviewList.reviewNo}">
		    	<td class="prodRowPno">${reviewList.reviewNo}</td>
				<td class="prodRowBrand">${rpList[status.index].productNo}</td>
				<td class="prodRowName">${reviewList.detailNo}</td>
				<td class="prodRowPrice">${rpclList[status.index].productBrand}</td>
				<td class="prodRowStart">${rpList[status.index].productName}</td>
				<td class="prodRowEnd">${reviewList.reviewScore}</td>
				<td class="prodRowEnd">${reviewList.userId}</td>
				<td class="prodRowEnd">${reviewList.reviewDate}</td>
